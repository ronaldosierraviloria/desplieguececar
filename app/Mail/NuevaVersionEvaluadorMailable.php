...
class NuevaVersionEvaluadorMailable extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Nueva Versión con Correcciones Disponible para Re-evaluación [{$codigo}] - Plazo: {$this->diasHabiles} Días Hábiles",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.nueva_version_evaluador',
        );
    }
