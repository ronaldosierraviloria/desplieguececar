...
class EvaluadorAsignadoMailable extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Asignación como Evaluador de Proyecto [{$codigo}] - Plazo: {$this->diasHabiles} Días Hábiles",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.evaluador_asignado',
        );
    }
