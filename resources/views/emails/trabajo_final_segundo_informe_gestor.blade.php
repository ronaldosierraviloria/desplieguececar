...
<head>
    ...
    <title>Alerta - Corrección de Informe Final Requerida</title>
    <style>
        ...
        .header { background-color: #c2410c; padding: 28px 32px; color: #ffffff; }
        .header h1 { margin: 0; font-size: 18px; font-weight: 600; }
        .header p { color: #ffedd5; margin: 4px 0 0 0; font-size: 13px; }
        .body-content { padding: 32px; }
        .greeting { font-size: 16px; font-weight: 600; color: #0f172a; margin-bottom: 12px; }
        .text { font-size: 14px; line-height: 1.6; color: #475569; margin-bottom: 24px; }
        .alert-box { background-color: #fff7ed; border-left: 4px solid #f97316; padding: 16px; border-radius: 4px; margin-bottom: 24px; font-size: 14px; color: #9a3412; }
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Notificación de Segundo Informe / Corrección de Informe Final</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) {{ $nombreDestinatario }} ({{ $rolDestinatario }}),</div>
                <div class="text">
                    Le informamos que la evaluación del Informe Final del siguiente Trabajo de Grado ha determinado que se requiere **someter un segundo informe / documento con correcciones**:
                </div>

                <div class="alert-box">
                    <strong>Acción Requerida:</strong> Por favor estar atentos a la carga del segundo informe final por parte de los estudiantes para dar continuidad al proceso de re-evaluación.
                </div>
