...
<head>
    ...
    <title>Re-evaluación Finalizada - Gestor</title>
    <style>
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Notificación de Re-evaluación para Gestor</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) Gestor(a) {{ $nombreGestor }},</div>
                <div class="text">
                    Le informamos que ha finalizado el proceso de re-evaluación del documento corregido para el siguiente proyecto:
                </div>
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <td class="label">Dictamen Final</td>
