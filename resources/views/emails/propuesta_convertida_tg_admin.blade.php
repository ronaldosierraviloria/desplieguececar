...
<head>
    ...
    <title>Propuesta Convertida a Trabajo de Grado</title>
    <style>
        ...
        .header { background-color: #4338ca; padding: 28px 32px; color: #ffffff; }
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Notificación para Administrador</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) Administrador(a) {{ $nombreAdmin }},</div>
                <div class="text">
                    Le informamos que la siguiente propuesta de grado se ha convertido oficialmente en **Trabajo de Grado** al haberse cargado el Informe Final correspondiente:
                </div>
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <td class="label">Modalidad Reclasificada</td>
                        <td class="value">Trabajo de Grado</td>
                    </tr>
