...
<head>
    ...
    <title>Evaluación de INFORME FINAL de Trabajo de Grado</title>
    <style>
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Asignación de Evaluación de Informe Final</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) Profesor(a) {{ $nombreEvaluador }},</div>
                <div class="text">
                    Le notificamos que se encuentra disponible el **Informe Final de Trabajo de Grado** para su evaluación y calificación definitiva:
                </div>

                <div class="alert-box">
                    <strong>Plazo de Evaluación:</strong> Dispone de un plazo de <strong>{{ $diasHabiles }} Días Hábiles</strong> a partir de la fecha para registrar su evaluación. Fecha límite: <strong>{{ $fechaLimiteFormatted }}</strong>.
                </div>
                ...
                <div class="text">
                    Por favor ingrese al sistema para revisar el documento final y diligenciar la rúbrica del trabajo de grado.
                </div>
            </div>
            <div class="footer">
