...
<head>
    ...
    <title>Confirmación Nueva Versión Subida</title>
    <style>
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Confirmación de Recepción de Correcciones</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) {{ $nombreEstudiante }},</div>
                <div class="text">
                    Confirmamos que la nueva versión corregida de su propuesta de grado ha sido cargada exitosamente al sistema.
                </div>
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td class="value">Versión Corregida en Re-evaluación</td>
                    </tr>
                </table>

                <div class="text">
                    El documento ha sido enviado nuevamente a los evaluadores correspondientes, quienes cuentan con un plazo reglamentario de 15 días hábiles para emitir su nueva calificación.
                </div>
            </div>
            <div class="footer">
