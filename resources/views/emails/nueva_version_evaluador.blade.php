...
<head>
    ...
    <title>Nueva Versión Disponible para Re-evaluación</title>
    <style>
        ...
        .header { background-color: #1e3a8a; padding: 28px 32px; color: #ffffff; }
        .header h1 { margin: 0; font-size: 18px; font-weight: 600; }
        .header p { color: #93c5fd; margin: 4px 0 0 0; font-size: 13px; }
        .body-content { padding: 32px; }
        .greeting { font-size: 16px; font-weight: 600; color: #0f172a; margin-bottom: 12px; }
        .text { font-size: 14px; line-height: 1.6; color: #475569; margin-bottom: 24px; }
        .alert-box { background-color: #eff6ff; border-left: 4px solid #2563eb; padding: 16px; border-radius: 4px; margin-bottom: 24px; font-size: 14px; color: #1e40af; }
    ...
    <div class="wrapper">
        <div class="main-card">
            <div class="header">
                ...
                <p>Nueva Versión Disponible con Correcciones</p>
            </div>
            <div class="body-content">
                <div class="greeting">Estimado(a) Profesor(a) {{ $nombreEvaluador }},</div>
                <div class="text">
                    Se ha cargado al sistema la **nueva versión con correcciones** del proyecto asignado:
                </div>

                <div class="alert-box">
                    <strong>Nuevo Plazo Habilitado:</strong> Se han otorgado <strong>{{ $diasHabiles }} Días Hábiles</strong> a partir de la fecha para revisar las correcciones y emitir el dictamen final. Fecha límite: <strong>{{ $fechaLimiteFormatted }}</strong>.
                </div>
                ...
                <div class="text">
                    Por favor ingrese al sistema para descargar el nuevo documento corregido y registrar su evaluación final.
                </div>
            </div>
            <div class="footer">
