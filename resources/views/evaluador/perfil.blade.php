...
<div class="max-w-4xl mx-auto" x-data="{ showEditModal: false, loading: false }">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('evaluador.dashboard') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-[#07321e] transition-all">
                ...
                <div>
                    ...
                    <div class="mt-8 space-y-4">
                        <div class="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                            ...
                            <div>
                                <p class="text-xs text-gray-600 font-bold uppercase tracking-wider">Correo Institucional</p>
