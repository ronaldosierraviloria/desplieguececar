...
try {
    ...
    echo '<h2>Laravel Vercel Exception Diagnostic</h2>';
    echo '<p><strong>Message:</strong> ' . htmlspecialchars($e->getMessage()) . '</p>';
    echo '<p><strong>File:</strong> ' . htmlspecialchars($e->getFile()) . ' (Line ' . $e->getLine() . ')</p>';
    echo '<details><summary>Click for Stack Trace</summary><pre style="white-space: pre-wrap; font-size: 12px; background: #fff; padding: 10px; border: 1px solid #eee;">' . htmlspecialchars($e->getTraceAsString()) . '</pre></details>';
    echo '</div>';
}
